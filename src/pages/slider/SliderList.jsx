    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className='flex justify-between items-center p-2'>
                <HeaderBox text1={"داشبورد"} text2={false}  text3={"بنر"}/>
            </div>
