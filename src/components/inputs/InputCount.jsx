                ...
                <input
                    ...
                    className={`${
                        ...
                        getIn(formik.touched, name)
                            ? "border-red-500"
                            : "border-gray-300"
                    } ${isAllBalance?"":"pr-24"} focus-visible:border-cyan-300 border bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-200 text-sm rounded-lg focus-visible:outline-0 block w-full p-2 pr-14`}
